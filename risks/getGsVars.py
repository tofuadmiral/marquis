...
# we want to get historical data for the growths
prices=[]
for i in gsids:
    request_url = "https://api.marquee.gs.com/v1/data/USCANFPP_MINI/query"
...
# nowe we have all the gsids, want to get the corresponding average growths
# just get the growths like we did with the price 
